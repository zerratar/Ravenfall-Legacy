public static class Localization
{
    ...
    public const string PETRACE_NO_PET = "You need to equip a pet to play.";
    public const string PETRACE_ALREADY_PLAYING = "You're already playing.";
    public const string PETRACE_START_COMMAND = "racing";
    ...
    public const string MSG_FERRY_ARRIVED = "You have arrived at your destination, {islandName}!";
    ...
    public const string MSG_JOIN_RAID_DUNGEON = "You cannot fight a raid boss when participating in a dungeon!";
