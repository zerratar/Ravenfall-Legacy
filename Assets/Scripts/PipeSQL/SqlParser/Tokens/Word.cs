...
namespace SqlParser.Tokens
{
    ...
    public class Word : StringToken
    {
        ...
        public Word(string value, char? quoteCharacter = null) : base(value)
        {
            ...
            var index = System.Array.BinarySearch(Keywords.All, value.ToUpperInvariant());
        ...
        public Keyword Keyword { get; set; } = Keyword.undefined;
        ...
        {
            var quote = $"{(QuoteStyle.HasValue ? GetEndQuote(QuoteStyle.Value) : '\0')}";
