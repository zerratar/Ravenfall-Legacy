public class EnchantmentCooldown : ChatBotCommandHandler
{
    ...
    public override async void Handle(GameMessage gm, GameClient client)
    {
        ...
        client.SendReply(gm, "You have to wait {timeLeft} before you can try to enchant something again. If you want to clear this cooldown, use !enchant clear cooldown, this will cost {pricePerSecond} coins per second. ~Total {totalCost} coins", cooldownString, clearCost, totalCost);
    }
