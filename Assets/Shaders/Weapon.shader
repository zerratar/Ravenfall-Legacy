...
Shader "Weapon"
{
	Properties
	{
		...
		[ASEEnd]_Emission("Emission", Color) = (1,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 _HandleColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_HandleColor);
				...
				float2 temp_cast_0 = ((IN.ase_texcoord7.xy.x*1.0 + 0.5)).xx;
				...
				float2 temp_cast_1 = ((IN.ase_texcoord7.xy.x*1.49 + -0.2)).xx;
				...
				float4 _BodyColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_BodyColor);
				float2 temp_cast_2 = ((IN.ase_texcoord7.xy.x*1.0 + -0.38)).xx;
				...
				float4 _InnerEdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_InnerEdgeColor);
				float2 appendResult10_g11 = (float2(0.5 , 0.23));
				float2 temp_output_11_0_g11 = ( abs( ((IN.ase_texcoord7.xy*1.0 + 0.03)*2.0 + -1.0) ) - appendResult10_g11 );
				...
				float4 _EdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_EdgeColor);
				
				float4 _TextureSample1_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_TextureSample1_ST);
				float2 uv_TextureSample1 = IN.ase_texcoord7.xy * _TextureSample1_ST_Instance.xy + _TextureSample1_ST_Instance.zw;
				float4 _Emission_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_Emission);
				
				float3 Albedo = ( ( _HandleColor_Instance * temp_output_38_0 ) + ( ( ( ( ( _HandleColor_Instance * temp_output_3_0 ) + ( ( ( saturate( min( break16_g7.x , break16_g7.y ) ) * _BodyColor_Instance ) + ( saturate( min( break16_g8.x , break16_g8.y ) ) * _InnerEdgeColor_Instance ) ) * ( 1.0 - temp_output_3_0 ) ) ) * ( 1.0 - temp_output_38_0 ) ) * ( 1.0 - temp_output_10_0 ) ) + ( temp_output_10_0 * _EdgeColor_Instance ) ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( tex2D( _TextureSample1, uv_TextureSample1 ) * _Emission_Instance ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 break16_g10 = ( 1.0 - ( temp_output_11_0_g10 / fwidth( temp_output_11_0_g10 ) ) );
				float temp_output_38_0 = saturate( min( break16_g10.x , break16_g10.y ) );
				float2 temp_cast_0 = ((IN.ase_texcoord2.xy.x*1.0 + 0.5)).xx;
				float2 appendResult10_g9 = (float2(0.67 , 1.0));
				float2 temp_output_11_0_g9 = ( abs( (temp_cast_0*2.0 + -1.0) ) - appendResult10_g9 );
				float2 break16_g9 = ( 1.0 - ( temp_output_11_0_g9 / fwidth( temp_output_11_0_g9 ) ) );
				float temp_output_3_0 = saturate( min( break16_g9.x , break16_g9.y ) );
				float2 temp_cast_1 = ((IN.ase_texcoord2.xy.x*1.49 + -0.2)).xx;
				float2 appendResult10_g7 = (float2(0.5 , 0.5));
				float2 temp_output_11_0_g7 = ( abs( (temp_cast_1*2.0 + -1.0) ) - appendResult10_g7 );
				float2 break16_g7 = ( 1.0 - ( temp_output_11_0_g7 / fwidth( temp_output_11_0_g7 ) ) );
				float4 _BodyColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_BodyColor);
				float2 temp_cast_2 = ((IN.ase_texcoord2.xy.x*1.0 + -0.38)).xx;
				float2 appendResult10_g8 = (float2(0.5 , 0.5));
				float2 temp_output_11_0_g8 = ( abs( (temp_cast_2*2.0 + -1.0) ) - appendResult10_g8 );
				float2 break16_g8 = ( 1.0 - ( temp_output_11_0_g8 / fwidth( temp_output_11_0_g8 ) ) );
				float4 _InnerEdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_InnerEdgeColor);
				float2 appendResult10_g11 = (float2(0.5 , 0.23));
				float2 temp_output_11_0_g11 = ( abs( ((IN.ase_texcoord2.xy*1.0 + 0.03)*2.0 + -1.0) ) - appendResult10_g11 );
				float2 break16_g11 = ( 1.0 - ( temp_output_11_0_g11 / fwidth( temp_output_11_0_g11 ) ) );
				float temp_output_10_0 = saturate( min( break16_g11.x , break16_g11.y ) );
				float4 _EdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Weapon,_EdgeColor);
...
/*ASEBEGIN
Version=18500
875.3334;158.6667;1473.333;1003.667;1731.764;968.8359;2.279843;True;True
...
Node;AmplifyShaderEditor.ColorNode;45;-2311.365,520.697;Inherit;False;InstancedProperty;_InnerEdgeColor;Inner Edge Color;5;0;Create;True;0;0;False;0;False;0,1,0.9608457,0;0.5368903,0.8962264,0.6087576,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;44;-2298.854,264.0796;Inherit;False;InstancedProperty;_BodyColor;Body Color;4;0;Create;True;0;0;False;0;False;0,0.6602616,1,0;0.3721075,0.6981132,0.4165628,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;26;-2312.492,782.0015;Inherit;False;InstancedProperty;_HandleColor;Handle Color;2;0;Create;True;0;0;False;0;False;0.3773585,0.1495812,0.01957992,0;0.1981132,0.1981132,0.1981132,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-2308.499,1030.539;Inherit;False;InstancedProperty;_EdgeColor;Edge Color;3;0;Create;True;0;0;False;0;False;0,0.9631133,1,0;0.3027768,0.7924528,0.3669966,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;53;-2319.548,1424.95;Inherit;False;InstancedProperty;_Emission;Emission;6;0;Create;True;0;0;False;0;False;1,0,0,0;0.06180737,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;59;1185.436,-230.3206;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;55;1185.436,-230.3206;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;56;1185.436,-230.3206;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Weapon;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;57;1185.436,-230.3206;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;58;1185.436,-230.3206;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;60;1185.436,-230.3206;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=8F8C52D3BA59FCD9B10B0D8440CE25973E447E43