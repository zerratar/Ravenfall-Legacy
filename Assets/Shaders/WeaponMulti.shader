	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float clampResult72 = clamp( cos( _TimeParameters.x * 0.5 ) , -0.5 , 0.5 );
				float2 temp_cast_0 = ((IN.ase_texcoord7.xy.x*1.0 + clampResult72)).xx;
				...
				float mulTime57 = _TimeParameters.x * 0.1;
				float3 hsvTorgb3_g13 = HSVToRGB( float3(mulTime57,1.0,1.0) );
				float3 temp_output_56_6 = hsvTorgb3_g13;
				float4 _HandleColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_HandleColor);
				float2 appendResult10_g17 = (float2(1.0 , 0.5));
				float2 temp_output_11_0_g17 = ( abs( (IN.ase_texcoord7.xy*2.0 + -1.0) ) - appendResult10_g17 );
				...
				float2 temp_cast_2 = ((IN.ase_texcoord7.xy.x*1.0 + 0.5)).xx;
				...
				float2 temp_cast_3 = ((IN.ase_texcoord7.xy.x*1.49 + -0.2)).xx;
				...
				float4 _BodyColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_BodyColor);
				float2 temp_cast_5 = ((IN.ase_texcoord7.xy.x*1.0 + -0.38)).xx;
				...
				float4 _InnerEdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_InnerEdgeColor);
				float2 appendResult10_g18 = (float2(0.5 , 0.23));
				float2 temp_output_11_0_g18 = ( abs( ((IN.ase_texcoord7.xy*1.0 + 0.03)*2.0 + -1.0) ) - appendResult10_g18 );
				...
				float4 _EdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_EdgeColor);
				...
				float clampResult68 = clamp( (IN.ase_texcoord7.xy.x*_TimeParameters.z + 0.0) , 0.25 , 1.0 );
				float4 temp_output_76_0 = ( ( temp_output_70_0 * temp_output_43_0 ) + ( ( 1.0 - temp_output_70_0 ) * ( clampResult68 * temp_output_43_0 ) ) );
				
				float4 _TextureSample1_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_TextureSample1_ST);
				float2 uv_TextureSample1 = IN.ase_texcoord7.xy * _TextureSample1_ST_Instance.xy + _TextureSample1_ST_Instance.zw;
				float4 _Emission_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_Emission);
				
				float grayscale78 = Luminance(temp_output_76_0.rgb);
				
				float3 Albedo = temp_output_76_0.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( tex2D( _TextureSample1, uv_TextureSample1 ) * ( float4( temp_output_56_6 , 0.0 ) * _Emission_Instance ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = grayscale78;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float clampResult72 = clamp( cos( _TimeParameters.x * 0.5 ) , -0.5 , 0.5 );
				float2 temp_cast_0 = ((IN.ase_texcoord2.xy.x*1.0 + clampResult72)).xx;
				float2 appendResult10_g19 = (float2(1.0 , 1.0));
				float2 temp_output_11_0_g19 = ( abs( (temp_cast_0*2.0 + -1.0) ) - appendResult10_g19 );
				float2 break16_g19 = ( 1.0 - ( temp_output_11_0_g19 / fwidth( temp_output_11_0_g19 ) ) );
				float temp_output_70_0 = saturate( min( break16_g19.x , break16_g19.y ) );
				...
				float4 _HandleColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_HandleColor);
				float2 appendResult10_g17 = (float2(1.0 , 0.5));
				float2 temp_output_11_0_g17 = ( abs( (IN.ase_texcoord2.xy*2.0 + -1.0) ) - appendResult10_g17 );
				float2 break16_g17 = ( 1.0 - ( temp_output_11_0_g17 / fwidth( temp_output_11_0_g17 ) ) );
				float temp_output_38_0 = saturate( min( break16_g17.x , break16_g17.y ) );
				float2 temp_cast_2 = ((IN.ase_texcoord2.xy.x*1.0 + 0.5)).xx;
				float2 appendResult10_g16 = (float2(0.67 , 1.0));
				float2 temp_output_11_0_g16 = ( abs( (temp_cast_2*2.0 + -1.0) ) - appendResult10_g16 );
				float2 break16_g16 = ( 1.0 - ( temp_output_11_0_g16 / fwidth( temp_output_11_0_g16 ) ) );
				float temp_output_3_0 = saturate( min( break16_g16.x , break16_g16.y ) );
				float2 temp_cast_3 = ((IN.ase_texcoord2.xy.x*1.49 + -0.2)).xx;
				float2 appendResult10_g14 = (float2(0.5 , 0.5));
				float2 temp_output_11_0_g14 = ( abs( (temp_cast_3*2.0 + -1.0) ) - appendResult10_g14 );
				float2 break16_g14 = ( 1.0 - ( temp_output_11_0_g14 / fwidth( temp_output_11_0_g14 ) ) );
				float4 _BodyColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_BodyColor);
				float2 temp_cast_5 = ((IN.ase_texcoord2.xy.x*1.0 + -0.38)).xx;
				float2 appendResult10_g15 = (float2(0.5 , 0.5));
				float2 temp_output_11_0_g15 = ( abs( (temp_cast_5*2.0 + -1.0) ) - appendResult10_g15 );
				float2 break16_g15 = ( 1.0 - ( temp_output_11_0_g15 / fwidth( temp_output_11_0_g15 ) ) );
				float4 _InnerEdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_InnerEdgeColor);
				float2 appendResult10_g18 = (float2(0.5 , 0.23));
				float2 temp_output_11_0_g18 = ( abs( ((IN.ase_texcoord2.xy*1.0 + 0.03)*2.0 + -1.0) ) - appendResult10_g18 );
				float2 break16_g18 = ( 1.0 - ( temp_output_11_0_g18 / fwidth( temp_output_11_0_g18 ) ) );
				float temp_output_10_0 = saturate( min( break16_g18.x , break16_g18.y ) );
				float4 _EdgeColor_Instance = UNITY_ACCESS_INSTANCED_PROP(MultiWeapon,_EdgeColor);
				float4 temp_output_43_0 = ( ( ( float4( temp_output_56_6 , 0.0 ) * _HandleColor_Instance ) * temp_output_38_0 ) + ( ( ( ( ( _HandleColor_Instance * temp_output_3_0 ) + ( ( ( saturate( min( break16_g14.x , break16_g14.y ) ) * ( float4( temp_output_56_6 , 0.0 ) * _BodyColor_Instance ) ) + ( saturate( min( break16_g15.x , break16_g15.y ) ) * ( float4( temp_output_56_6 , 0.0 ) * _InnerEdgeColor_Instance ) ) ) * ( 1.0 - temp_output_3_0 ) ) ) * ( 1.0 - temp_output_38_0 ) ) * ( 1.0 - temp_output_10_0 ) ) + ( temp_output_10_0 * ( float4( temp_output_56_6 , 0.0 ) * _EdgeColor_Instance ) ) ) );
				float clampResult68 = clamp( (IN.ase_texcoord2.xy.x*_TimeParameters.z + 0.0) , 0.25 , 1.0 );
				float4 temp_output_76_0 = ( ( temp_output_70_0 * temp_output_43_0 ) + ( ( 1.0 - temp_output_70_0 ) * ( clampResult68 * temp_output_43_0 ) ) );
...
/*ASEBEGIN
Version=18500
875.3334;158.6667;1473.333;1003.667;1646.78;1715.728;4.117545;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;82;2839.424,-138.643;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;81;2839.424,-138.643;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;83;2839.424,-138.643;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;79;2839.424,-138.643;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;80;2839.424,-138.643;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;MultiWeapon;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;84;2839.424,-138.643;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;80;2;54;0
WireConnection;80;3;78;0
ASEEND*/
//CHKSM=96D0F18467D5D2D50F23124B85473E3355BC8569